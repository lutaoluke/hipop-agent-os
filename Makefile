...
.PHONY: test test-chat test-governance test-judge test-wf1-ingest test-wf1-history test-all

test: test-governance test-judge test-wf1-ingest test-wf1-history
	@echo ""
	@echo "✓ governance + judge + wf1-ingest + wf1-history smoke passed"
...
test-wf1-history:
	@echo "▶ wf1 history smoke (库存 as_of_date dated 快照层 → 历史抽检, WS-22)"
...
test-all: test-governance test-judge test-wf1-ingest test-wf1-history test-chat
	@echo ""
