...
.PHONY: test test-chat test-governance test-judge test-replenish-inputs test-all

test: test-governance test-judge test-replenish-inputs
	@echo ""
	@echo "✓ governance + judge + replenish-inputs smoke passed"
...
test-all: test-governance test-judge test-replenish-inputs test-chat
	@echo ""
