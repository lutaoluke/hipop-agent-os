...
.PHONY: test test-chat test-governance test-judge test-sales-contract test-wf1-ingest test-all

test: test-governance test-judge test-sales-contract test-wf1-ingest
	@echo ""
	@echo "✓ governance + judge + sales-contract + wf1-ingest smoke passed"
...
test-all: test-governance test-judge test-sales-contract test-wf1-ingest test-chat
	@echo ""
